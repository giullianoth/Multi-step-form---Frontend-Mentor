...
Este projeto é um desafio da plataforma [Frontend Mentor](https://www.frontendmentor.io/challenges/multistep-form-YVAnSdqQBJ), que consiste em um formulário de múltiplas etapas simulando a assinatura de um plano para games.

*This project is a challenge from the [Frontend Mentor](https://www.frontendmentor.io/challenges/multistep-form-YVAnSdqQBJ) platform, which consists of a multi-step form simulating the subscription to a game plan.*
...
![Captura de tela em 1440px | Screenshot in 1440px](/public/images/screenshots/screenshot_1440px.jpeg)

Captura de tela em 1440px | Screenshot in 1440px

---

![Captura de tela em 768px | Screenshot in 768px](/public/images/screenshots/screenshot_768px.jpeg)

Captura de tela em 768px | Screenshot in 768px

---

![Captura de tela em 375px | Screenshot in 375px](/public/images/screenshots/screenshot_375px.jpeg)

Captura de tela em 375px | Screenshot in 375px

---

Você também pode conferir a página acessando [este link](https://multi-step-form-pied-three.vercel.app/).

*You can also check the page by accessing [this link](https://multi-step-form-pied-three.vercel.app/).*
